    ...
    <div class="courseMain">
        <div class="courseIntroduction">
            <div class="orgranization">
                <img src="/public/media/organization/<%out.print(organization.getID() + "/" + organization.getLogo());%>"
                     alt="">
            </div>
            ...
            <div class="instructorInfor">
                <img src=<%out.print(request.getContextPath() + "/public/media/user/" + lecturer.getID() + "/" + lecturer.getAvatar());%> alt=""
                     class="instructorImg">
                <p class="instructorName">
                    Instructor: <a
                        href="/profile/<%out.print(lecturer.getUsername());%>"><%out.print(lecturer.getFirstName() + " " + lecturer.getLastName());%></a>
                </p>
            </div>
            <div class="price">
