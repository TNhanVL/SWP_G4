<%-- Document : dashboard Created on : Jun 29, 2023, 12:54:53 AM Author : TTNhan --%>
                                            ...
                                            <% ArrayList<User> users = UserDAO.getAllUsers();
                                                for (int i = 0; i < users.size(); i++) { %>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <%switch (users.get(i).getRole()) { case 0:
                                                                out.print("Student"); break; case 1:
                                                                out.print("Lecturer"); break; } %>
                                                        </td>
                                                        <td>
                                                            <%switch (users.get(i).getStatus()) { case 0:
                                                                out.print("Locked"); break; case 1: out.print("Legal");
                                                                break; } %>
                                                        </td>
                                                        <td>
                                                            <a
