drop table [admin], chosenAnswer, answer, question, quizResult, post, lessonCompleted, lesson, chapter, cartProduct, purchasedCourse, [certificate], course, lecturer, [user], organization, country
-- Create the tables
CREATE TABLE [admin] (
...
GO
INSERT INTO organization([name], picture, [description]) VALUES
...
(2, 1)
GO
INSERT INTO course(name,[image],[description],organizationID,lecturerID,originPrice,price,rate) VALUES
...
('C++', 'a.png', 'hard', 1, 3, 800, 5, 4.7)
GO
INSERT INTO cartProduct(userID, courseID) VALUES
(1, 2), (1, 3)
GO
...
(1, 2)
GO
INSERT INTO chapter(courseID, [index], name, [description]) VALUES
(1, 1, N'Hiragana 。ひらがな', ''),
(1, 2, N'Katakana 。かたがな', ''),
(2, 1, N'Test chapter', '')
GO
INSERT INTO lesson(chapterID, name, [index], [type], [time]) VALUES
(1, 'A, Ka Row', 1, 3, 3),
(1, 'Sa, Ta Row', 2, 3, 3),
