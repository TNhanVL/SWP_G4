    ...
    <div class="shopping-cart">
        ...
        <form class="courseInCart" method="post" action="checkOut">
            ...
            <div class="items">
                ...
                <!-- an item -->
                <div class="item">
                    <input type="checkbox" id="course<%out.print(courseIndex);%>" name="course"
                           value="<%out.print(course.getID());%>">

                    <a href="/course/<%out.print(course.getID());%>">
                        <img src="/public/media/course/<%out.print(course.getID() + "/" + course.getImage());%>"
                             class="itemImg" alt="">
                        <div class="itemInformation">
                            <p class="itemName"><%out.print(course.getTitle());%></p>
                            <div class="itemRating"><%out.print(course.getRate());%><i class="fa-solid fa-star"></i>
                                (2503 reviewer)
                            </div>
                        </div>
                    </a>
                    ...
                    <div class="itemEdit"><a href="./cart/deleteOrder/<%out.print(course.getID());%>"><i
